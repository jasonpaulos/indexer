...
type IndexerDb interface {
	...
	SetBlockCommitHook(onBlockCommit func(header types.BlockHeader, txns []types.SignedTxnWithAD, createdPrimitives map[int]uint64, participants map[string][]int))
